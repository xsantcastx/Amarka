...
export class AdminSidebarComponent {
  ...
  adminLinks = [
    ...
    },
    {
      ...
      route: '/admin/legacy/collections',
      icon: 'M4 6h16M4 12h16M4 18h16'
    },
    {
      label: 'Legacy Models',
      route: '/admin/legacy/models',
    ...
    {
      label: 'Legacy Custom Orders',
      route: '/admin/legacy/custom-orders',
    ...
    {
      label: 'Legacy Discounts',
      route: '/admin/legacy/discounts',
